#ifndef _PAPERINKCONVERTER_H_
#define _PAPERINKCONVERTER_H_
...
public:
	PaperInkConverter(const char* filename, int RelativThreshold, int AbsoluteThreshold, int SlidingThreshold);
	~PaperInkConverter();
	int EOF_Found();
